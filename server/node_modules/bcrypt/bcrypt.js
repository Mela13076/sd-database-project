...
// var binding_path = nodePreGyp.find(path.resolve(path.join(__dirname, '..', 'bcrypt', 'lib', 'binding', 'napi-v3', 'bcrypt_lib.node')));
// const binding_path = require(path.join(__dirname, 'node_modules', 'bcrypt'));

// const binding_path = require.resolve('bcrypt');
